		...
		try
		{
			...
			while (iter.hasNext())
			{
				...
				if (item.isFormField())
				{
					...
					else if(name.equals("describephoto")){
				...
				else
				{
						...
						|| contentType.equals("image/png"))
					{
						...
						String path="C:\\Users\\Ming\\workspaceweb\\album\\src\\main\\webapp\\uploadfiles\\";
						FileOutputStream output = new FileOutputStream(
							path+"\\"+serverFileName + suffix);
						...
						input.close();
						output.close();
						System.out.println(title+" "+describe);
						as.addPhoto(user , title, serverFileName + suffix,describe);
