...
import org.crazyit.album.domain.Comment;
...
public class BaseDaoHibernate4<T> implements BaseDao<T>
{
	...
	protected List<T> findtop(String hql,int count)
	{
	...
	@SuppressWarnings("unchecked")
	protected void deletecurimg(String hql){
		Query query = getSessionFactory().getCurrentSession()
				.createQuery(hql);
		//执行更新
		query.executeUpdate();
	...
	@SuppressWarnings("unchecked")
	protected void updatesql(String hql){
		Query query = getSessionFactory().getCurrentSession()
				.createQuery(hql);
		//执行更新
		query.executeUpdate();
